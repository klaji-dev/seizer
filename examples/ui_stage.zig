...
pub fn init() !void {
    ...
    hello_button.default_style.text_color = seizer.color.argb(f64).BLACK;
    hello_button.default_style.background_color = seizer.color.argb(f64).WHITE;
    ...
    hello_button.hovered_style.text_color = seizer.color.argb(f64).BLACK;
    hello_button.hovered_style.background_color = seizer.color.argb(f64).WHITE;
    ...
    hello_button.clicked_style.text_color = seizer.color.argb(f64).BLACK;
    hello_button.clicked_style.background_color = seizer.color.argb(f64).WHITE;
