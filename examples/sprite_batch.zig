...
var player_image: seizer.image.Linear(seizer.color.argbf32_premultiplied) = undefined;
...
pub fn init() !void {
    ...
    player_image = try seizer.image.Linear(seizer.color.argbf32_premultiplied).fromMemory(gpa.allocator(), @embedFile("assets/wedge.png"));
